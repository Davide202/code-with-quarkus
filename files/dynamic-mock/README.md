...
You can then execute your native executable with: `./target/webapp-mvc-1.0.0-SNAPSHOT-runner`
...
-v /percorso/sul/tuo/host/routes.json:/app/config/routes.json \
-e MOCK_ROUTES_FILE=/app/config/routes.json \
my-dynamic-it.davide.mock:1.0
